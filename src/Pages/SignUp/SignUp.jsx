            ...
            .then(result => {
                ...
                updateUserProfile({
                    ...
                    .then(() => {
                        ...
                        fetch('https://college-booking-server-md-arefin.vercel.app/users', {
                            method: "POST",
                            headers: {
                            ...
                            <div className="card flex-shrink-0 w-full max-w-md shadow-2xl bg-rose-900 ">
                                <div className="card-body">
                                    ...
                                    <p className=' mt-4 text-white text-lg'>
                                        Already have an account? <Link to='/login' className='hover:text-black hover:underline'>Please Login</Link>
                                    </p>
