...
const Research = () => {
    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full px-5'>
                {
                    research.map(paper => <div key={paper._id} className="card w-96 bg-base-100 shadow-xl">
